        ...
        <table class="table table-hover">
            ...
            <tbody>
              <?php
                ...
                $query = "SELECT ProductName, BrandName, Votes, TVotes, CDPHId, CSFId, 	SubCategoryId, 	ChemicalId FROM itemdescription WHERE SubCategory NOT LIKE '%skin%' and  SubCategory NOT LIKE '%eye%' and SubCategory NOT LIKE '%foundation%' and SubCategory NOT LIKE '%lip%'  ORDER BY Votes/TVotes DESC";
