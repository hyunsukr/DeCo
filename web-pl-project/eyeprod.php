        ...
        <table class="table table-hover">
            ...
            <tbody>
              <?php
                ...
                $query = "SELECT ProductName, BrandName, Votes, TVotes, CDPHId, CSFId, 	SubCategoryId, 	ChemicalId FROM itemdescription WHERE SubCategory LIKE '%eye%' ORDER BY Votes/TVotes DESC";
