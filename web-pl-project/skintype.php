...
<!-- Background image and title/menu bar -->
  ...
  <body background="image/brush.jpg">
    ...
    <!-- Sample links -->
    <div class="skintype">
        <h3 style="text-align: center; font-size: 40px; margin-bottom: 20px;">Skin Type</h3>
        <p>Recommendation of products based on the user's skin type
            such as oily, combination, and dry</p>
        <ol>
            <li><a id="link" href="foundationex1.html">Product for Skin Type Combination: Luminous Silk Foundation</a>
            </li>
