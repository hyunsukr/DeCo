        ...
        <table class="table table-hover">
            ...
            <tbody>
              <?php
                ...
                //select all skin care products
                $query = "SELECT ProductName, BrandName, Votes, TVotes, CDPHId, CSFId, 	SubCategoryId, 	ChemicalId FROM itemdescription WHERE SubCategory LIKE '%skin%' ORDER BY Votes/TVotes DESC";
