        ...
        <table class="table table-hover">
            ...
            <tbody>
              <?php
                ...
                //Select all products that are for the eye
                $brandname = $_GET["brand"];
                echo '<h3 style="text-align: center;padding-top:5px;font-family:' . " 'Fredericka the Great', cursive;" .'">'. $_GET['brand'] . '</h3>';
                echo '<thead>
                <tr>
                ...
                $query = "SELECT ProductName, BrandName, Votes, TVotes, CDPHId, CSFId, 	SubCategoryId, 	ChemicalId FROM itemdescription WHERE BrandName = '$brandname' ORDER BY Votes/TVotes DESC";
                ...
                if (sizeof($results) == 0) {
                    echo "There seems to be nothing at this time for this brand! Sorry for the inconvience! ";
                  }
                foreach ($results as $result) {
                    if ($counter < 100) {
                        ...
                        //calculate the ratings in terms of /5
                        if ($result["Votes"] == 0) {
                        echo '<td>0/5</td>';
                        }
                        else {
